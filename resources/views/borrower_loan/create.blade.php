...
@endsection
@section('breadcrumbs')
{!! Breadcrumbs::render('new_borrower_loan') !!}
@endsection
@section('page_header','តារាងអតិថិជនថ្មី')
@section('page_description','បន្ថែមប្រាក់កម្ចីថ្មី')
@section('content')
    ...
    <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form action="/borrower_loan" class="form-horizontal" method="POST" enctype="multipart/form-data">
            {{csrf_field()}}
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="input-group">
                            <input type="number" min="100000" step="10000" class="form-control input-circle-left" placeholder="" name="amount">
